import { day5Part1, day5Part2, buildSeedList, buildAlmanac, Almanac } from "../src/day5"
...
`
    ...
    // Act
    const res = buildAlmanac(testData)(buildSeedList(testData))
...
test("Day 5 part 2 generates correct value for known data set", () => {
    const testData = `
seeds: 79 14 55 13
